...
class ProjectWorkers(models.Model):
    ...
    project_id = models.ForeignKey(Projects, on_delete=models.CASCADE, verbose_name="Project", related_name="Contractor_project")
    worker_id = models.ForeignKey(Workers, on_delete=models.CASCADE, verbose_name="Worker",  related_name="Contractor_project_worker")
